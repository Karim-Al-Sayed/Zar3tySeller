...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.MyViewHolder> {
    ...
    Context context;
    public ItemAdapter(ArrayList<SellerItems> sellerlist, Context context) {
    ...
    public void onBindViewHolder(@NonNull ItemAdapter.MyViewHolder holder, int position) {
        ...
        Toast.makeText(context.getApplicationContext(),getItemCount() + "Length",Toast.LENGTH_LONG).show();
